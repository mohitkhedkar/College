...
### Assignment-18 : 
Write a function template selection Sort. Write a program that inputs, sorts and outputs an integerarray and a float array.
...
### Assignment-22 :
Write C++ program using STL toadd binary numbers (assume one bit as one number); use STL stack.
