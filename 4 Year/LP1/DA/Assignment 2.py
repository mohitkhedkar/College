# Assignment -2 : Download Pima Indians Diabetes dataset. Use Naive Bayes‟ Algorithm for classification 
...
filename = "diabetes1.csv.txt"
splitRatio = 0.67
dataset = loadCsv("diabetes1.csv.txt")
